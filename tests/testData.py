...
test_data = {
    ...
    "nw_off_no_services": {
        "name": "SharedNetwork-without-services",
        "displaytext": "SharedNetwork-without-services",
        "guestiptype": "Shared",
        "supportedservices": "",
        "specifyVlan": "True",
    ...
    "nw_off_userdata_VR": {
        "name": "SharedNetwork-with-Userdata-VR",
        "displaytext": "SharedNetwork-with-Userdata-VR",
        "guestiptype": "Shared",
    ...
    "ssh-password-template-xen": {
        "displaytext": "cent56-passwd",
        "name": "cent56-passwd",
        "passwordenabled": True,
        "url": "http://10.147.28.7/templates/passwordssh/cent56-ssh-passwd-configdrive.vhd",
        "format": "VHD",
        "ostype": "CentOS 5.6 (64-bit)",
        "hypervisor": "XenServer"
    },
    "ssh-password-template-kvm": {
        "displaytext": "cent55-passwd",
        "name": "cent55-passwd",
        "passwordenabled": True,
        "url": "http://10.147.28.7/templates/passwordssh/cent55-ssh-passwd-configdrive.qcow2",
        "format": "QCOW2",
